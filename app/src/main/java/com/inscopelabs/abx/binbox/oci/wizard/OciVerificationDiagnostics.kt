...
data class OciVerificationDiagnostics(
    ...
    fun getTroubleshootingSuggestions(): List<String> {
        ...
        when {
            ...
            isSignatureFailure -> {
                list.add("Key Mismatch: The private key in Bin Box does not match the public key registered in Oracle Cloud. Ensure you uploaded the exact public key generated by this app.")
                list.add("Fingerprint Mismatch: Confirm that the fingerprint in Bin Box ('$fingerprint') matches the fingerprint shown in Oracle Cloud Console under your API Keys.")
