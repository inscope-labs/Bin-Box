...
import com.example.terminal.model.StyledSegment
import com.example.terminal.model.TerminalLine
import com.example.terminal.model.TerminalStyle
            ...
            when {
                ...
                ch == '\r' -> {
                    ...
                    if (i + 1 < len && input[i + 1] == '\n') {
                        ...
                        flushCurrentSegment()
                        // Keep line or overwrite if needed
                        i++
                    }
                }
