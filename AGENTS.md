# Standing Instructions for AI Studio Build Agent — BinBox
...
## 5. Role Boundaries — AI Studio vs Claude/Tooling

Full spec: `Hosted_Local_Shell-Addendum-Roles.md` (repo root).
